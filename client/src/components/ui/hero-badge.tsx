...
const sizeVariants: Record<string, string> = {
  sm: "px-2 py-1 text-xs gap-1 sm:px-3 sm:gap-1.5",
  md: "px-3 py-1.5 text-xs gap-1.5 sm:px-4 sm:text-sm sm:gap-2",
  lg: "px-4 py-2 text-sm gap-2 sm:px-5 sm:text-base sm:gap-2.5",
};
...
export default function HeroBadge({
  ...
  const baseClassName = cn(
    "inline-flex items-center rounded-full border transition-colors max-w-full",
